    ...
    ngOnInit() {
        ...
        promise
            .then(() => {
                ...
                let documents = isAndroid ? FileSystemModule.knownFolders.currentApp() : FileSystemModule.knownFolders.documents();
            ...
            .navigate(
                ['preview'],
                {
                    queryParams: {
                        ...
                        outputFormat: this._selectedOutputFormat ?this._selectedOutputFormat.value : undefined,
